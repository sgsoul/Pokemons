...
public class Main {
    public static void main(String[] args) {
        ...
        //лямба-выражение, которое возвращает "Против этого "
        Text textAgainstThis;
        textAgainstThis = () -> "Против этого ";

        //лямба-выражение, которое возвращает ", когда увидел "
        Text textWhenSaw;
        textWhenSaw = () -> ", когда увидел ";

        //лямба-выражение, которое возвращает "но "
        Text textBut;
        textBut = () -> "но ";

        //лямба-выражение, которое возвращает " и "
        Text textAnd;
        textAnd = () -> " и ";

        //лямба-выражение, которое возвращает " а "
        Text textA;
        textA = () -> " а ";

        //лямба-выражение, которое возвращает "Конечно, "
        Text textOfCourse;
